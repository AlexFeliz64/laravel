<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Administracion de Generos') }} - {{ __('ACTUALIZAR GENERO') }}
            </h2>
    ...
    <form action="{{ route('admin.generos.update', $genero->id) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        @include('admin.generos.partials.form',
        ['title'=> __('Actualizar Generos'),
        'submit'=>true])
    </form>
